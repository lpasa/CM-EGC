                        ...
                        for n_heads in n_heads_list:
                            for n_pc in n_pc_list:
                                ...
                                if not os.path.exists(training_log_dir):
                                    ...
                                    graph, features, labels, n_classes, _, _, _ = DGLDatasetReader(dataset_name, self_loops, device)

                                    train_mask, test_mask, valid_mask = get_rnd_full_masks(features.shape[0], 0.2, run + 1)
